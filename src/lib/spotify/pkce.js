...
// --------------------------------------------------------------------------
// SHA-256 (pure JS) — needed because crypto.subtle is unavailable on
// non-secure HTTP origins (e.g. http://192.168.x.x:3000/).
// --------------------------------------------------------------------------
...
export async function createCodeChallenge(verifier) {
  ...
  // Prefer Web Crypto when available (secure contexts), fall back to pure JS.
